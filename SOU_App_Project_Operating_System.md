...
**Do not silently pick one.** Before starting any implementation work, confirm the actual current priority with Matthew, or re-read `PRODUCT_ROADMAP.md` in full to check whether it explicitly resolves the ordering.
